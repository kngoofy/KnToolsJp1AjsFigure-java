package org.westclan.kntools.jp1ajsfigure.data;

/**
 * テストデータ JP1/AJS のユニット定義ファイル
 */
    ...
    public static final String Data = """
            ...
            unit=test_ajs,,jpluser,;
            {
                ...
                unit=NET01,,jpluser,;
                {
                    ...
                    cm="NET01ネット コメント";
                    sz=20x28;
                    el=JOB01-NET01,j,+80+240;
                    el=JOB02-NET01,j,+240+48;
                    el=FLCK_DDDD-NET01,j,+80+144;
                ...
                unit=NET02,,jpluser,;
                {
                    ...
                    el=JOB05-NET02,j,+240+336;
                    el=FLCK_DDDD-NET02,j,+880+528;
                    ar=(f=JOB04-NET02,t=JOB05-NET02,seq);
                    ar=(f=JOB04-NET02,t=FLCK_DDDD-NET02,seq);
                    sd=1,2018/11/01;
                    st=1,17:00;
                    cy=1,(1,d);
                    sh=1,ca;
